...
(function () {
    ...
    require(['http://cdn.leafletjs.com/leaflet-0.7.3/leaflet.js', 'angular']);

    define([], function() {

        var mapHosterLeaflet = function (PositionViewCtrl, GeoCoder, utils, AgoNewWindowConfig) {
		...
		return ['controllers/PositionViewCtrl', 'lib/GeoCoder', 'lib/utils', 'lib/AgoNewWindowConfig', MapHosterLeaflet];
	});
}());
