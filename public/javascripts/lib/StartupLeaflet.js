...
(function () {
    ...
    define([], function () {
        var startupLeaflet = function(MapHosterLeaflet, StompSetupCtrl, AgoNewWindowConfig) {
    ...
    */
        ...
        return ['lib/MapHosterLeaflet', 'controllers/StompSetupCtrl', 'lib/AgoNewWindowConfig', startupLeaflet];
